...
dependencies {
    ...
    testImplementation("io.kotest:kotest-runner-junit5:5.2.0") // for kotest framework
    testImplementation("io.kotest:kotest-assertions-core:5.2.1") // for kotest core assertions
    testImplementation("io.kotest:kotest-assertions-core-jvm:5.2.1") // for kotest core jvm assertions
}
