...
plugins {
    ...
    id("org.danilopianini.git-sensitive-semantic-versioning") version "1.1.7"
...
dependencies {
    ...
    testImplementation("io.kotest:kotest-runner-junit5:5.6.1") // for kotest framework
    testImplementation("io.kotest:kotest-assertions-core:5.6.1") // for kotest core assertions
    testImplementation("io.kotest:kotest-assertions-core-jvm:5.6.1") // for kotest core jvm assertions
