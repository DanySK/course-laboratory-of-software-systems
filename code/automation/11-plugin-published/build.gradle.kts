...
dependencies {
    ...
    testImplementation("io.kotest:kotest-runner-junit5:5.6.0") // for kotest framework
    testImplementation("io.kotest:kotest-assertions-core:5.6.0") // for kotest core assertions
