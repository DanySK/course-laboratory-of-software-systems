plugins {
    ...
    kotlin("jvm") version "1.6.21" // version is necessary
}
...
dependencies {
    ...
    testImplementation("io.kotest:kotest-assertions-core:5.3.0") // for kotest core assertions
    testImplementation("io.kotest:kotest-assertions-core-jvm:5.3.0") // for kotest core jvm assertions
}
